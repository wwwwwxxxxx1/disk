...
<div class="wrap">
    ...
    <div class="x-body">
        <div class="content">
            <div class="monthly">
                <p>
                    <%--@declare id="sel"--%><a href="javascript:window.history.back()"   > <img width="25" src="images/fileIcons/back.png" ></a>&nbsp;	&nbsp;	&nbsp;	&nbsp;<label for="sel" style="color:#A30014;font-weight:bold;font-family: 'Montserrat', sans-serif">词频分析 >${param.filePath} </label>
                </p>
                <hr />

                <div>
                    <img id="imgwait"   src="images/loading.gif" />
