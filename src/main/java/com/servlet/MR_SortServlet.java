...
@WebServlet(name = "MR_SortServlet", value = "/MR_SortServlet")
public class MR_SortServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private String HDFS_PATH="hdfs://10.90.6.168:8020/";
    protected void service(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            fs.delete(new Path("hdfs://10.90.6.168:8020/testing/part_sort_tmp"), true);

            // 指明计算完成以后,输出结果放在哪里
            FileOutputFormat.setOutputPath(job, new Path("hdfs://10.90.6.168:8020/testing/part_sort_tmp"));
            ...
            FileInputFormat.setInputPaths(job2, new Path("hdfs://10.90.6.168:8020/testing/part_sort_tmp/part-r-00000"));

            job2.setOutputKeyClass(ScoreInfo.class);
            job2.setOutputValueClass(Text.class);
            fs.delete(new Path("hdfs://10.90.6.168:8020/testing/part_sort_result"), true);
            FileOutputFormat.setOutputPath(job2, new Path("hdfs://10.90.6.168:8020/testing/part_sort_result"));


            boolean result=job2.waitForCompletion(true);


            Path path = new Path("hdfs://10.90.6.168:8020/testing/part_sort_result/part-r-00000");
