...
public class SortPartitionTest {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException {
        ...
        //指定用户输入的文件的路径
        Path path=new Path("hdfs://10.90.6.168:8020/testing/score.txt");
        ...
        //指明计算结果存放的位置
        Path outputPath=new Path("hdfs://10.90.6.168:8020/testing/sortresulttmp");
        ...
        //指定第二个map要读入的文件是哪个
        Path path3=new Path("hdfs://10.90.6.168:8020/testing/sortresulttmp/part-r-00000");
        ...
        //指定最终的结果存放地址
        Path path4=new Path("hdfs://10.90.6.168:8020/testing/sortresult");
